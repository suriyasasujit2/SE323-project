    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.Error ? "An error has occurred., Password Incorrect (รหัสผ่านไม่ถูกต้อง) "
                : "";
        ...
        public PartialViewResult _ChangePasswordPartial(ManageUserViewModel model)
        {
        ...
        public async Task<ActionResult> Manage(ManageUserViewModel model)
        {
            ...
            if (hasPassword)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ViewBag.PasswordNotMatch = "Error! Incorrect Password (รหัสผ่านไม่ถูกต้อง).";
                        AddErrors(result);
                    }
                }
            }
